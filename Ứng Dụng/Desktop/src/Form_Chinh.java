...
public class Form_Chinh extends javax.swing.JFrame implements ActionListener
{
	...
	try 
	{
	        ...
	        for (int i=1; i<=6;i++)//so hang
                {
                   ...
                   if( i==6 )
                   {
                       row.add(formatter.format(Double.valueOf(rs.getString(i)))+"đ");
                       continue;
                   }
                    row.add(rs.getString(i));
                }
        ...
        SanPhamTB.getColumnModel().getColumn(0).setPreferredWidth(30);
        SanPhamTB.getColumnModel().getColumn(1).setPreferredWidth(30);
        SanPhamTB.getColumnModel().getColumn(2).setPreferredWidth(130);
        SanPhamTB.getColumnModel().getColumn(3).setPreferredWidth(30);
        SanPhamTB.getColumnModel().getColumn(4).setPreferredWidth(30);
        SanPhamTB.getColumnModel().getColumn(5).setPreferredWidth(60);
    } 
    public void SoDoBan()
    {
        ...
        try 
        {
            rs=truyvan.executeQuery("SELECT SoBan, NoUse, MaKV, TenBan  "
                                    + "FROM BanPhong "
                                    + "WHERE NoUse not like 2 and NoUse not like 3");
            while (rs.next())
            {
	    
                JButton button = new JButton(" "+rs.getString(4));//lay ten ban
                //button.setName(rs.getString(1));//lay ma so cua ban
...
//---------------------------------------
    public void NhomHang()//hien liên ds nhóm sp
    {
        try 
        {
            ...
            while (rs.next())
            {
                JButton button = new JButton(rs.getString(2));
 ...
 //--------------------------------------------
    ...
    public  void FormatTBHoaDon()
    {
        MonAnTB.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        MonAnTB.getColumnModel().getColumn(0).setPreferredWidth(100);
        MonAnTB.getColumnModel().getColumn(1).setPreferredWidth(30);
        MonAnTB.getColumnModel().getColumn(2).setPreferredWidth(60);
        MonAnTB.getColumnModel().getColumn(3).setPreferredWidth(75);
    }
    //---------------------------------------------------
...
//        System.err.println(cT_TaoMa.TaoHoaDon())
            //String a = o.getBackground()
            SoBanLB.setText(o.getText());//ten ban
            MaBan = S.trim();
            ...
            if( CTBP.KiemTraBanPhong(MaBan).equals("1") )//bàn phong mà dã có nguoi su dụng
            {
                MonAnTB.setModel( CTHD.HienCT(MaBan) );//tra ve bang ban do
                FormatTBHoaDon();
                MaHDLB.setText( CTHD.LayMaCT(MaBan) );
        ...
        else 
        {
            if( S.compareTo("SP") >0 )//SK khi bấm vào Từng món ăn
            {
                ...
                {
                    String MaHD = MaHDLB.getText().trim();
                    String MaSP = S.trim();
    ...
    private void initComponents() {
        ...
        SanPhamTB = new javax.swing.JTable();
        ...
        MaHDLB.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        MaHDLB.setForeground(new java.awt.Color(204, 0, 0));
        MaHDLB.setText("N/A");
        ...
        jPanel13Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel13Layout.createSequentialGroup()
                ...
                .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel13Layout.createSequentialGroup()
                        .addComponent(SoBanLB, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel13Layout.setVerticalGroup(
            ...
            .addGroup(jPanel13Layout.createSequentialGroup()
                ...
                .addGroup(jPanel13Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(MaHDLB, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        SanPhamTB.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        SanPhamTB.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        SanPhamTB.setGridColor(new java.awt.Color(153, 255, 153));
        SanPhamTB.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                SanPhamTBMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(SanPhamTB);
        ...
        KhácLayout.setHorizontalGroup(
            ...
            .addGroup(KhácLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(KhácLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
        ...
        KhácLayout.setVerticalGroup(
            ...
            .addGroup(KhácLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(KhácLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(KhácLayout.createSequentialGroup()
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(10, 10, 10)
                        .addComponent(XoaKHBT, javax.swing.GroupLayout.DEFAULT_SIZE, 166, Short.MAX_VALUE)
                        .addGap(21, 21, 21))))
        );
    ...
    private void ChuyenBanBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChuyenBanBTActionPerformed
        ...
        if (option == JOptionPane.OK_OPTION) 
        {
            ...
            CT_HoaDon CTHD = new CT_HoaDon();
            CTHD.ChuyenBan(MaBan, BanMoi, MaHD);
            SoDoBan();
        }
    ...
    private void BanMoiBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BanMoiBTActionPerformed
        ...
        //lay ma hd
        CT_TaoMa cT_TaoMa = new CT_TaoMa();
        String MaHD= "CT"+cT_TaoMa.TaoHoaDon();
        HD.TaoHD(MaBan, MaNV, MaHD);
        MaHDLB.setText(MaHD);
        SoDoBan();
    ...
    private void SanPhamTBMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SanPhamTBMouseClicked
        // TODO add your handling code here:
        int qa = SanPhamTB.getSelectedRow();
        jTextField3.setText((String) SanPhamTB.getValueAt(qa, 0));
        TenKHTF2.setText((String) SanPhamTB.getValueAt(qa, 2));
        ThuDKTF2.setText((String) SanPhamTB.getValueAt(qa, 5));
        String a = SanPhamTB.getValueAt(qa, 4).toString();
        //int a =Integer.valueOf((String)jTable3.getValueAt(qa, 5));
        jSpinner6.setValue(Integer.valueOf(a));
    }//GEN-LAST:event_SanPhamTBMouseClicked
...
//        CT_TaoMa cT_TaoMa = new CT_TaoMa();
//        SP.setMaSP( "SP"+cT_TaoMa.TaoHoaDon() );
...
//            LoadTableSP();
        ...
        try 
        {
            ...
            ps.setString(1, "SP"+cT_TaoMa.TaoHoaDon());
            ps.setString(2, MaNhomCB2.getSelectedItem().toString().trim());
            ps.setString(3, TenKHTF2.getText().trim());
            ps.setString(4, jComboBox6.getSelectedItem().toString().trim());
            ps.setInt(5, Integer.valueOf( jSpinner6.getValue().toString() ));
            ps.setFloat(6,Float.valueOf( ThuDKTF2.getText().trim()) );
            ps.setInt(7, 1);
            ps.executeUpdate();
            JOptionPane.showMessageDialog(this, "Sản Phẩm Đã Được Thêm");
            LoadTableSP();
    ...
    private void TinhTienBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TinhTienBTActionPerformed
        ...
        Q_ChungTu h = new Q_ChungTu(MaNVLB.getText().trim(), TenNVLB.getText().trim(), MaHDLB.getText().trim());
    ...
    private void XoaHDBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_XoaHDBTActionPerformed
        // TODO add your handling code here:
        int returnValue = JOptionPane.showConfirmDialog(null, "Bạn có muốn xóa Chứng   " + MaHDLB.getText().toString().trim(), "Bạn chắc chứ?", JOptionPane.YES_NO_OPTION);
        if (returnValue == JOptionPane.YES_OPTION) 
        {
            CT_HoaDon HD = new CT_HoaDon();
            HD.XoaHD( MaHDLB.getText().trim(), MaBan.trim() );
            SoDoBan();
            MonAnTB.setModel(new DefaultTableModel());
            MaHDLB.setText("N/A");
        }
    ...
    private javax.swing.JTable SanPhamTB;
