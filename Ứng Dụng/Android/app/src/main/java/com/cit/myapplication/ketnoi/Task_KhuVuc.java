...
public class Task_KhuVuc extends AsyncTask<String,String,String> {

    String URL;
    private Activity_KhuVuc networkResponseListener;
    public Task_KhuVuc(Activity_KhuVuc networkResponseListener, String URL){
        this.URL=URL;
