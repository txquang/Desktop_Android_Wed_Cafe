...
import com.cit.myapplication.Activity_TrangChu;
...
public class Task_TrangChu extends AsyncTask<String,String,String> {

    String URL;
    private Activity_TrangChu networkResponseListener;
    public Task_TrangChu(Activity_TrangChu networkResponseListener, String URL){
        this.URL=URL;
