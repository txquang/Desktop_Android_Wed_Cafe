...
public class Task_MonAn extends AsyncTask<String,String,String> {

    String URL;
    private Activity_MonAn networkResponseListener;
    public Task_MonAn(Activity_MonAn networkResponseListener, String URL){
        this.URL=URL;
